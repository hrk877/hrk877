...
export const products: Product[] = [
    {
        ...
        price: 800,
        stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_STICKER ?? "",
        emoji: "🍌",
        available: true,
    },
    {
        ...
        price: 12800,
        stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_RING ?? "",
        emoji: "💍",
        available: true,
        comingSoon: true,
    },
    {
        ...
        price: 4800,
        stripePriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_TSHIRT ?? "",
        emoji: "👕",
        available: true,
    },
]
